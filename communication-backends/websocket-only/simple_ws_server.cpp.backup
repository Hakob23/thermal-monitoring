...
private:
    ...
    void BroadcastMessage(const std::string& message) {
        ...
        if (connected_clients_map_.empty()) return;
        ...
        delete[] buf;
        messages_sent_ += connected_clients_map_.size(); // Count message per client
    }
    ...
    void PrintPerformanceStats() {
        ...
        std::cout << "Connected clients: " << connected_clients_map_.size() << std::endl;
